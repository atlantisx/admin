<div data-bind="visible: loadingItem" class="loading"><?php echo trans('admin::admin.loading') ?></div>

<form class="edit_form" data-bind="visible: !loadingItem(), submit: saveItem">
	<h2 data-bind="text: $root[$root.primaryKey]() ? '<?php echo trans('admin::admin.edit') ?>' :
		'<?php echo trans('admin::admin.createnew') ?>'"></h2>
