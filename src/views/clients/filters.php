<form class="fill-up">
    <div class="box-header">
        <span class="title"><?php echo trans('admin::admin.filters') ?></span>
    </div>
    <div class="box-content padded filters">
        ...
        <div class="form-group">
            ...
            <!-- ko if: type === 'bool' -->
            <input type="hidden"
                   data-bind="value: value, attr: {id: field_id}, select2: {data: {results: $root.boolOptions}}"/>
            <!-- /ko -->
            ...
            <!-- ko if: type === 'date' -->
            <input type="text"
                   data-bind="value: min_value, attr: {id: field_id + '_min'}, datepicker: {dateFormat: date_format}"/>
            <span>-</span>
            <input type="text"
                   data-bind="value: max_value, attr: {id: field_id + '_max'}, datepicker: {dateFormat: date_format}"/>
            <!-- /ko -->

            <!-- ko if: type === 'time' -->
            <input type="text"
                   data-bind="value: min_value, attr: {id: field_id + '_min'}, timepicker: {timeFormat: time_format}"/>
            <span>-</span>
            <input type="text"
                   data-bind="value: max_value, attr: {id: field_id + '_max'}, timepicker: {timeFormat: time_format}"/>
            <!-- /ko -->
            ...
            <!-- ko if: autocomplete -->
            <input type="hidden"
                   data-bind="value: value, attr: {id: field_id}, select2Remote: {field: field_name, type: 'filter', filterIndex: $index()}"/>
            <!-- /ko -->
            <!-- ko ifnot: autocomplete -->
            <input type="hidden"
                   data-bind="value: value, attr: {id: field_id}, select2: {data: {results: $root.listOptions[field_name]}}"/>
            <!-- /ko -->
            <!-- /ko -->
