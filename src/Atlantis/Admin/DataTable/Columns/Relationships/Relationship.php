<?php
namespace Atlantis\Admin\DataTable\Columns\Relationships;

use Atlantis\Admin\DataTable\Columns\Column;
...
class Relationship extends Column {
	...
	public function getRelationshipWheres($relationship, $tableAlias, $pivotAlias = null, $pivot = null)
	{
		...
		array_splice($query->wheres, (method_exists($relationshipModel, 'isSoftDeleting') ? 1 : 0), 1);
