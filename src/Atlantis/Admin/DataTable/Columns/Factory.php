<?php
namespace Atlantis\Admin\DataTable\Columns;

use Atlantis\Admin\Validator;
use Atlantis\Admin\Config\ConfigInterface;
use Illuminate\Database\DatabaseManager as DB;

use Atlantis\Admin\DataTable\Columns\Relationships\BelongsTo;
use Atlantis\Admin\DataTable\Columns\Relationships\BelongsToMany;
use Atlantis\Admin\DataTable\Columns\Relationships\HasOneOrMany;
...
class Factory {
	 ...
	 * The config instance
	 *
	 * @var \Atlantis\Admin\Config\ConfigInterface
	 */
	protected $config;
	 ...
	 *
	 * @param \Atlantis\Admin\Validator 				$validator
	 * @param \Atlantis\Admin\Config\ConfigInterface	$config
	 ...
	 * @param array		$options
	 *
	 * @return \Atlantis\Admin\DataTable\Columns\Column
	 */
	...
	public function getIncludedColumns(array $fields)
	{
		...
		if (!sizeof($this->includedColumns))
		{
			...
			{
				if (is_a($field, 'Atlantis\\Admin\\Fields\\Relationships\\BelongsTo'))
				{
