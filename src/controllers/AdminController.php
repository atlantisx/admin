...
class AdminController extends Controller
{
	...
	public function dashboard()
	{
		...
		if (Config::get('admin::admin.use_dashboard'))
		{
			//set the layout content
			$this->layout->content = View::make(Config::get('admin::admin.dashboard_view'));
		}
		//else we should redirect to the menu item
		else
		{
			$configFactory = App::make('admin_config_factory');
			$home = Config::get('admin::admin.home_page');
